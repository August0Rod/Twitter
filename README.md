...
<img src='https://submissions.us-east-1.linodeobjects.com/metau_android/f4r4kg2n.gif' title='TwitterApp' width='' alt='Video Walkthrough' />

GIF created with [Kap](https://getkap.co/).

## Notes

The most difficult part was the different API calls and how to implement them into the app.
...
## License
    ...
    Copyright [2022] [Augusto Rodriguez]
